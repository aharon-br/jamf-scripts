...
## This will remove the location and user info, and unmanage, of the desired computers from the smart search of computers 
...
encryptedString="STRING_FROM_ENCRYPTION"
salt="SALT_FROM_ENCRYPTION"
passphrase="PASSPHRASE_FROM_ENCRYPTION"
